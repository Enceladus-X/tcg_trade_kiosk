...
- 현재 준비 버전: `v0.5.8`
- 준비 중인 릴리스 파일명: `dist/MarinfordKiosk_v0.5.8.exe`
- GitHub Releases 정리 완료
- `release-notes/` 폴더에 `v0.1.0`부터 `v0.5.8`까지 문서 정리
...
- `release-notes/v0.1.0.md` ~ `release-notes/v0.5.8.md`
  - 형식과 어체 통일 완료
...
3. `lib/use-orders.ts`
4. 최신 릴리스 노트 `release-notes/v0.5.8.md`
5. `README.md`
...
현재 최신 커밋 흐름상, 문서와 릴리스 준비는 `v0.5.8` 기준으로 맞춰진 상태입니다.
