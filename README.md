...
![version](https://img.shields.io/badge/version-v0.5.0-amber)
...
- 최신 릴리스: [v0.5.0](https://github.com/Enceladus-X/tcg_trade_kiosk/releases/latest)
...
현재 `v0.5.0` 기준으로 다음 기능이 포함되어 있습니다.
