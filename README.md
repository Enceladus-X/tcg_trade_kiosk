...
![version](https://img.shields.io/badge/version-v0.6.1-amber)
...
현재 `v0.6.1` 기준으로 다음 기능이 포함되어 있습니다.
...
- 마일리지 지급 선택 시 추가 지급률 강조 표시
- 관리자 매입 요청 목록 단계적 표시 및 더 보기
- 가격 조정 이력 접기 / 펼치기와 이력 건수 표시
